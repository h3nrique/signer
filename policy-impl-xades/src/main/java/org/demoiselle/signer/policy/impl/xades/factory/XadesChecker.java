...
/**
 * Factory specialized in manufacturing objects for interface {@link Checker}
 *
 * @author Paulo Henrique Alves <paulohenriqueas13@gmail.com>
 */
public class XadesChecker extends GenericFactory<Checker> {

	public static final XadesChecker instance = new XadesChecker();

	public static final XadesChecker getInstance() {
		return XadesChecker.instance;
	}
	 ...
	 *
	 * @return xades checker
	 * @see XMLChecker
	 */
	@Override
	public XMLChecker factoryDefault() {
